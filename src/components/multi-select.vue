<template>
  <div id="multiselct">
    <component :is="selectType"></component>
  </div>
</template>

<script>
  
  import selectMultiple from './multiselect-types/select-multiple'
  import selectCheckbox from './multiselect-types/select-checkbox'
  import selectSingle from './multiselect-types/select-single'
